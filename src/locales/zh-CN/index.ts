export const zhCN = {
  ...
  voyagerImportTitle: "从 Gemini Voyager 导入",
  voyagerImportDesc: "导入文件夹整理结果，并增量合并到当前账号",
  voyagerImportAction: "开始导入",
  voyagerImportPlaceholder:
    "粘贴 Gemini Voyager 导出的 JSON 内容，例如 gemini-voyager.folders.v1 ...",
  voyagerImportConfirm: "确认将 Voyager 文件夹结构增量导入到当前 Gemini 账号？",
  voyagerImportVersion: "Voyager 版本",
  voyagerImportFolderCount: "文件夹",
  voyagerImportConversationCount: "会话",
  voyagerImportNewFolders: "新增文件夹",
  voyagerImportNewConversations: "新增会话",
  voyagerImportMovedConversations: "移动会话",
  voyagerImportPreservedConversations: "保留原文件夹",
  voyagerImportFlattenNotice: "层级文件夹会压平成路径名称，例如“父级 / 子级”。",
  ...
  voyagerImportGeminiOnly: "请在 Gemini 页面打开数据管理后再执行 Voyager 导入。",
  voyagerImportGeminiHint:
    "仅支持 Gemini Voyager 的 `gemini-voyager.folders.v1` JSON。导入内容会自动归入当前打开的 Gemini 账号。",
  voyagerImportPasteRequired: "请先选择 Voyager 文件或粘贴 JSON 内容",
  voyagerImportInvalidFormat: "不是 Gemini Voyager 文件夹导出格式",
  voyagerImportInvalidData: "缺少有效的文件夹或内容数据",
  voyagerImportEmpty: "导入文件中没有可用的文件夹",
